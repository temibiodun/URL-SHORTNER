  ...
  return (
    <div className="container mx-auto p-2">
      <div className="bg-banner my-8 rounded-xl bg-cover bg-center">
        ...
        <p className="text-white text-center pb-2 text-xl font-extralight ">Past Your Untidy Link Here</p>
        <p className='text-white text-center pb-4 text-sm font-thin'>Free tool to shorten or reduce your link and url</p>
